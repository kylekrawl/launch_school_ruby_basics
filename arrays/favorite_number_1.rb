...
# containing all three groups. What does this look like? 
# (You don't need to write any code here. Just alter the 
# value shown so it meets the exercise requirements.)
